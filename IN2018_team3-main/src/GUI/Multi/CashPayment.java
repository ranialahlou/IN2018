...
public class CashPayment {
    ...
    public CashPayment(JPanel bPanel, Connection conn) {
        ...
        jobCode.setLocation((int) (panel.getWidth() * 0.38), (int) (panel.getHeight() * 0.23));
        jobCode.setSize(100, 25);
        jobCode.setVisible(true);

        jobCodeText.setLocation((int) (panel.getWidth() * 0.28),  (int) (panel.getHeight() * 0.20));
        jobCodeText.setSize(200, 50);
        jobCodeText.setVisible(true);

        taskID.setLocation((int) (panel.getWidth() * 0.38), (int) (panel.getHeight() * 0.30));
        taskID.setSize(100, 25);
        taskID.setVisible(true);

        taskIdText.setLocation((int) (panel.getWidth() * 0.28),  (int) (panel.getHeight() * 0.27));
        ...
        accountNumberText.setLocation((int) (panel.getWidth() * 0.28),  (int) (panel.getHeight() * 0.34));
