...
public class CustomerReport {
    ...
    public CustomerReport(JFrame frame, Connection conn) {
        ...
        accountnumber.setLocation((int) (panel.getWidth() * 0.42), (int) (panel.getHeight() * 0.64));
        accountnumber.setSize(100, 25);
        accountnumber.setVisible(true);

        accountNumberText.setLocation((int) (panel.getWidth() * 0.42),  (int) (panel.getHeight() * 0.72));
    ...
    public CustomerReport(JPanel panel) {
