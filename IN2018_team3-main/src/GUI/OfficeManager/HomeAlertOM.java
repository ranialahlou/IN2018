...
public class HomeAlertOM {

    JTable alerts = new JTable();
    JPanel newPanel = new JPanel();
    String[] columns = {"Name", "Job ID", "Alert"};

    public HomeAlertOM(JPanel panel, Connection conn) {
        ...
        try{
            ...
            ResultSet rs = stmt.executeQuery("SELECT customer.FirstName, customer.LastName, job.JobID " +
                    "FROM customer, job " +
